...
base_dir <- 'C:/Users/Jeff/Dropbox/Work/mystic/db'
```
...
```{r connect}
ch <- db_connect(path = file.path(base_dir, "MysticDB_20150227.accdb"))
```
...
```{r load-wq}
wq <- load_wq(path = file.path(base_dir, "MysticDB_20150227.accdb"), sample_types = c("S"), exclude_flags = TRUE)
str(wq)
```
