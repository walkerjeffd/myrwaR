...
```{r load-prcp-usgs}
prcp_usgs <- load_precip_from_usgs(start_date="2015-01-01", end_date="2015-01-10")
str(prcp_usgs)
```
...
ggplot(prcp[1:(24*30), ], aes(Datetime)) +
  geom_line(aes(y=Precip)) +
  geom_line(aes(y=Precip24), color='red') +
  geom_line(aes(y=Precip24.max), color='red', linetype=2) +
  geom_line(aes(y=Precip48), color='deepskyblue') +
  geom_line(aes(y=Precip48.6), color='chartreuse3') +
  theme_bw()
```
